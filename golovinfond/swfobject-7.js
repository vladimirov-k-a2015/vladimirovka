...
<!-- content region -->
  ...
  <div class="gutter inner clearfix">
    ...
    <div class="content clearfix">
      <div class="view view-topics view-id-topics view-display-id-page view-dom-id-41ebe040edb75fbacef3490d1955883a">
...
<li class="pager-item"><a title="На страницу номер 2" href="/topics/sites//all//libraries//swfobject//swfobject.js?page=1">2</a></li>
<li class="pager-item"><a title="На страницу номер 3" href="/topics/sites//all//libraries//swfobject//swfobject.js?page=2">3</a></li>
<li class="pager-item"><a title="На страницу номер 4" href="/topics/sites//all//libraries//swfobject//swfobject.js?page=3">4</a></li>
<li class="pager-item"><a title="На страницу номер 5" href="/topics/sites//all//libraries//swfobject//swfobject.js?page=4">5</a></li>
<li class="pager-item"><a title="На страницу номер 6" href="/topics/sites//all//libraries//swfobject//swfobject.js?page=5">6</a></li>
<li class="pager-item"><a title="На страницу номер 7" href="/topics/sites//all//libraries//swfobject//swfobject.js?page=6">7</a></li>
<li class="pager-item"><a title="На страницу номер 8" href="/topics/sites//all//libraries//swfobject//swfobject.js?page=7">8</a></li>
<li class="pager-item"><a title="На страницу номер 9" href="/topics/sites//all//libraries//swfobject//swfobject.js?page=8">9</a></li>
<li class="pager-ellipsis">…</li>
<li class="pager-next"><a title="На следующую страницу" href="/topics/sites//all//libraries//swfobject//swfobject.js?page=1">следующая ›</a></li>
<li class="pager-last last"><a title="На последнюю страницу" href="/topics/sites//all//libraries//swfobject//swfobject.js?page=26">последняя »</a></li>
</ul></div>  
...
<div id="block-search-form" class="block block-search contextual-links-region   odd grid16-4">
  <div class="gutter inner clearfix">
    ...
    <div class="content clearfix">
      <form action="/topics/sites//all//libraries//swfobject//swfobject.js" method="post" id="search-block-form" accept-charset="UTF-8"><div><div class="container-inline">
      <h2 class="element-invisible">Search form</h2>
    <div class="form-item form-type-textfield form-item-search-block-form">
  <label class="element-invisible" for="edit-search-block-form--2">Поиск </label>
 <input title="Введите ключевые слова для поиска." type="text" id="edit-search-block-form--2" name="search_block_form" value="" size="15" maxlength="128" class="form-text" />
</div>
<div class="form-actions form-wrapper" id="edit-actions"><input type="submit" id="edit-submit" name="op" value="Поиск" class="form-submit" /></div><input type="hidden" name="form_build_id" value="form-roB38uIXnjNocBFWeKFT-vXF9CXYe9TnG5ixebwY1JY" />
...
<div id="block-user-login" class="block block-user contextual-links-region  last even grid16-4">
  <div class="gutter inner clearfix">
    ...
    <div class="content clearfix">
      <form action="/topics/sites//all//libraries//swfobject//swfobject.js?destination=topics/sites//all//libraries//swfobject//swfobject.js" method="post" id="user-login-form" accept-charset="UTF-8"><div><div class="form-item form-type-textfield form-item-name">
...
</ul></div><input type="hidden" name="form_build_id" value="form-ymxMVBIIV5CJJH8lz4udVi2JIkw5_c9UNJ27crOkA54" />
